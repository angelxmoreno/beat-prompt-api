...
- [ ] Add a style-extraction compare/eval command (for example `prompt_style_extract_compare`) that consumes case fixtures and reports model/provider pass/fail with field-level mismatches.
